...
171:# 10 "C:/msys64/ucrt64/include/stdio.h" 2 3
182:# 33 "C:/msys64/ucrt64/include/stdio.h" 3
186:# 46 "C:/msys64/ucrt64/include/stdio.h" 3
...
pushq %rbp: Esta instrucción guarda (empuja o hace un push) el valor actual del registro "puntero base" (%rbp) en la pila de memoria

movq %rsp, %rbp: Aquí se copia (o "mueve") el valor del puntero actual de la pila (%rsp) hacia el puntero base (%rbp)

.seh_pushreg, .seh_setframe): Estas no son instrucciones de procesador, sino "directivas" o metadatos para el ensamblador
...
> **R:**Porque U son indefeinidos y T son ejecutables
...
> **R:**Los resuelve el cargos dinamico cuando los ejecute y como se cargan en tiempo de ejecución, el enlazador no las copia
...
> **R:**ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ffe4f520000)
        KERNEL32.DLL => /c/WINDOWS/System32/KERNEL32.DLL (0x7ffe4eaf0000)
        KERNELBASE.dll => /c/WINDOWS/System32/KERNELBASE.dll (0x7ffe4cca0000)
        ucrtbase.dll => /c/WINDOWS/System32/ucrtbase.dll (0x7ffe4d160000)
